Waiting to receive a True message from the Navigation stack. Once it is received, subscribe to the /target_position information published by YOLO Object Detection to confirm the target object's location. 
